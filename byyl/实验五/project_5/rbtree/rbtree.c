...
static inline void dummy_copy(struct rb_node *old, struct rb_node *new_node) {(void)old;(void)new_node;}
static inline void dummy_rotate(struct rb_node *old, struct rb_node *new_node) {(void)old;(void)new_node;}
